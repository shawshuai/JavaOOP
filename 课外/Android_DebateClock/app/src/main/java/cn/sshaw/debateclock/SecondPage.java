...
public class SecondPage extends AppCompatActivity {
    ...
    public int[] timeA_sec = {120};
    public int[] timeB_sec = {120};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamA = (TextView) findViewById(R.id.anti_team_A_name);
        teamB = (TextView) findViewById(R.id.anti_team_B_name);
        timeA_dis = (TextView) findViewById(R.id.anti_time_a);
        timeB_dis = (TextView) findViewById(R.id.anti_time_b);
        b_a = (Button) findViewById(R.id.anti_start_a);
        b_b = (Button) findViewById(R.id.anti_start_b);
        next = (Button) findViewById(R.id.anti_next_period);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Context context = SecondPage.this;
                Class destinationClass = gongbian.class;
